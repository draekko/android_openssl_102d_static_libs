...
ifneq (,$(filter -DZLIB, $(openssl_cflags_static_32) $(openssl_cflags_static_64)))
...
ifeq ($(TARGET_ARCH_ABI),$(filter $(TARGET_ARCH_ABI),x86_64 mips64 arm64-v8a))
LOCAL_CFLAGS += $(openssl_cflags_static_32)
else
LOCAL_CFLAGS += $(openssl_cflags_static_64)
endif
...
LOCAL_CFLAGS += \
  ...
  -I$(LOCAL_PATH)/jni \
  -I$(LOCAL_PATH)/jni\ssl \
  -I$(LOCAL_PATH)/jni\crypto \
  -I$(LOCAL_PATH)/jni\include \
  -I$(LOCAL_PATH)/jni/crypto/asn1 \
  -I$(LOCAL_PATH)/jni/crypto/evp \
  -I$(LOCAL_PATH)/jni/crypto/modes \
  -I. \
  -Issl \
  -Icrypto \
  -Iinclude \
...
else ifeq ($(TARGET_ARCH_ABI),$(filter $(TARGET_ARCH_ABI),armeabi))
...
else ifeq ($(TARGET_ARCH_ABI),$(filter $(TARGET_ARCH_ABI),armeabi-v7a))
...
else ifeq ($(TARGET_ARCH_ABI),$(filter $(TARGET_ARCH_ABI),mips))
...
else ifeq ($(TARGET_ARCH_ABI),$(filter $(TARGET_ARCH_ABI),mips64))
